...
{
  "numcli": " AF25",
  "nomcli": "LUIS AGUILAR ALVARADO",
  "calle": "GUERRERO",
  "numext": "610",
  "colonia": "CUAUHTEMOC SUR",
  "ciudad": "TECATE",
...
```json
{
  ...
  "updated": "2024-10-31 00:38:45",
  "numcli": " AF25",
  "nomcli": "LUIS AGUILAR ALVARADO MODIFICADO",
  "calle": "GUERRERO",
  "numext": "610",
  "colonia": "CUAUHTEMOC SUR",
  "ciudad": "TECATE",
...
|------------------------------------------|--------------------------------------------|
| Clientes con nombre ignacio              | /api/v3/clientes?q=inzagui                 |
| Clientes con nombre ignacio gonzalez     | /api/v3/clientes?q=inzagui+guerrero        |
